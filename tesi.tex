...
\begin{enumerate}
\item Acquisisce i dati necessari per costruire l'\textit{endorsement graph} associato ad un particolare \textit{hashtag controverso} presente nella \textit{social network} di \textit{Twitter} ;
