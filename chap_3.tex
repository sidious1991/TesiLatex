...
\\Evitando di scendere troppo nei dettagli implementativi, inseriamo di seguito un esempio di \textit{output} tipico del \textit{tool} proposto, che aiuta a chiarire quanto già detto.
