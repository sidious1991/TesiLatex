...
\\Tuttavia, visto che siamo interessati solamente all'entità del decremento dell'\textit{RWC} a seguito dell'aggiunta dell'arco, possiamo utilizzare un'altra modalità di calcolo più efficiente. In particolare, considerando la \textit{matrice delle probabilità di transizione per colonna P}, dopo l'aggiunta dell'arco diretto \textit{(x,y)} solo una sua colonna ne è affetta: la colonna che corrisponde al vertice di origine \textit{"x"} dell'arco \textit{(x,y)}.
\\Di seguito è evidenziata la colonna \textit{x-esima} prima e dopo l'aggiunta dell'arco diretto \textit{(x,y)}:

$P^T = \begin{bmatrix}
       \cdots & \cdots & \cdots & \cdots & \cdots & \cdots & \cdots \\[0.3em]
       \cdots & \cdots & \cdots & \cdots & \cdots & \cdots & \cdots \\[0.3em]
       \frac{1}{q} & \frac{1}{q} & \cdots & \frac{1}{q} & 0 & \cdots & 0 \\[0.3em]
       \cdots & \cdots & \cdots & \cdots & \cdots & \cdots & \cdots \\[0.3em]
       \cdots & \cdots & \cdots & \cdots & \cdots & \cdots & \cdots \\[0.3em]
     \end{bmatrix}$
